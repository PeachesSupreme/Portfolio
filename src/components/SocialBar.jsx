  ...
  return (
    <div className="widget-bar">
      <a
        ...
        target="_blank"
      >
        <img src="images/linkedin.png" alt="linkedin" className="widget-img" />
      </a>
      <a href="mailto:ryan.g.crowley@gmail.com" target="_blank">
        <img src="images/gmail.jpg" alt="gmail" className="widget-img" />
      </a>
      ...
      <a href="https://twitter.com/RCColaUnleashed" target="_blank">
        <img src="images/twitter.png" alt="twitter" className="widget-img" />
      </a>
